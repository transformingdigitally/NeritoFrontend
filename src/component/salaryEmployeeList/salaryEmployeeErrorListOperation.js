...
// Showing the failure validation response for PP.
function SalaryEmployeeErrorListOperation(props) {
    ...
    <>
      ...
      <Box className="payroll-tbl-wrap">
        <div className="payroll-tbl-inner">
          <Divider className="tbl-divider-pane" />
          <span>
            {props.isSuccesful === 2
              ? translation.FAILURE
              : translation.SUCCESS}
...
export default SalaryEmployeeErrorListOperation;
